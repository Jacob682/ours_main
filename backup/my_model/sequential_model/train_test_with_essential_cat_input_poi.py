...
dir_tra_padded_cat_int=
dir_tra_padded_poi_int=
dir_tra_padded_rec_delta_t=
dir_tra_padded_rec_delta_d=
dir_tra_y=
...
def Process_rec(users,padded_reindex_rec_cat_id,padded_reindex_rec_poi,
    ...
    '''
    users:(n_user,1)
    padded_reindex_rec_cat_id:(n_user,timestep,20)
    padded_rec_delta_t/d:(n_user,timestep,20),不需要embed，最后在模型里concat
    '''
...
pre_data=Process_rec(users,padded_reindex_rec_cat_id,padded_reindex_rec_poi,\
    padded_rec_delta_t,padded_rec_delta_d,padded_tgt_reindex_rec_poi,batch_size)
