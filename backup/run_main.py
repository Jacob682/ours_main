...
def main_nyc():
    ...
    mlp_units=[1024,512,1]
                                        #   0        1       2     3      4       5      6             
    num_x=[1078,3906,284,95,20,8,25]#[num_ueser,num_poi,num_cat,num_hsh,num_rec,num_day,num_hours],hsh[0-95],共96个，但该集中取不到95
...
@exec_time
def main_tky():
    dir_inputs='/home/liuqiuyu/code/my_code/dataset/data_process_tky.pkl'
    num_negs=[7057,7057]
    len_tra,len_tes=384774,2293
